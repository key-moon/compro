// detail: https://onlinejudge.u-aizu.ac.jp/status/users/keymoon/submissions/1/ALDS1_13_A/judge/4775409/C#
using System;
using System.IO;
using System.Linq;
...
class P
{
    static void Main()
    {
        ...
        char[][] map = Enumerable.Repeat(0, 8).Select(_ => Enumerable.Repeat('.', 8).ToArray()).ToArray();
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            hContains[r] = true;
            wContains[c] = true;
            hpwContains[r + c] = true;
            hmwp7Contains[r - c + 7] = true;
        }
        if (!IsPossible(map, hContains, wContains, hpwContains, hmwp7Contains)) goto end;
