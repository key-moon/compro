// detail: https://onlinejudge.u-aizu.ac.jp/status/users/keymoon/submissions/1/DSL_1_A/judge/4190082/C#
using System;
using System.Linq;
...
class P
{
    static void Main()
    {
        ...
        for (int i = 0; i < nq[1]; i++)
        {
            ...
            else Console.WriteLine(uf.Find(pab[1]) == uf.Find(pab[2]) ? "1" : "0");
        }
    }
}
