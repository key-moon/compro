// detail: https://onlinejudge.u-aizu.ac.jp/status/users/keymoon/submissions/1/DSL_2_D/judge/3814955/C#
using System;
using System.IO;
using System.Linq;
...
class SegmentTree<T>
{
    ...
    private void Propagate(int sectionIndex)
    {
        for (int i = Height - 1; i >= 1; i--)
        {
            ...
            Operators[leftChild] = Merge(Operators[leftChild], GetLeftHalf(Operators[section]));
            Operators[rightChild] = Merge(Operators[rightChild], GetRightHalf(Operators[section]));
