// detail: https://onlinejudge.u-aizu.ac.jp/status/users/keymoon/submissions/1/DSL_2_D/judge/3955199/C#
using System;
using System.IO;
using System.Linq;
...
static class P
{
    static void Main()
    {
        SegmentTree<int> segTree = new SegmentTree<int>(NextInt, int.MaxValue, (x, y) => y == int.MaxValue ? x : y);
        int q = NextInt;
