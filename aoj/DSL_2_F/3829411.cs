// detail: https://onlinejudge.u-aizu.ac.jp/status/users/keymoon/submissions/1/DSL_2_F/judge/3829411/C#
using System;
using System.IO;
using System.Linq;
...
class SegmentTree<DataT, OperatorT>
{
    ...
    private void Eval(int ind)
    {
        var a = (ind << 1);
        var b = (ind << 1) | 1;
        Operators[a] = MergeOperator(Operators[a], Operators[ind]);
        Operators[b] = MergeOperator(Operators[b], Operators[ind]);
