// detail: https://atcoder.jp/contests/abc006/submissions/23878242
using System;
...
public static class P
{
    public static void Main()
    {
        ...
        SegmentTree<int> segTree = new SegmentTree<int>(n + 1, int.MinValue, Max);
        segTree[0] = 0;
        for (int i = 0; i < n; i++)
        {
            var c = int.Parse(Console.ReadLine());
            segTree.Operate(c, segTree.Query(0, c) + 1);
        }
        Console.WriteLine(n - segTree.Query(0, n));
    }
}
