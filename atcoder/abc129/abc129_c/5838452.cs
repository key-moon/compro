// detail: https://atcoder.jp/contests/abc129/submissions/5838452
using System;
using System.IO;
using System.Linq;
...
static class P
{
    static void Main()
    {
        ...
        HashSet<int> broken = new HashSet<int>(Enumerable.Repeat(0, nm[1]).Select(_ => int.Parse(Console.ReadLine())).ToArray());
        ModInt prev2 = 0;
        ModInt prev = 1;
