// detail: https://atcoder.jp/contests/abc139/submissions/7804649
using System;
using System.IO;
using System.Net;
...
static class Reader
{
    ...
    private static byte Next { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { if (ptr >= buffer.Length) { Read(); ptr = 0; } return buffer[ptr++]; } }
