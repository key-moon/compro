// detail: https://atcoder.jp/contests/abc139/submissions/7804772
using System;
using System.IO;
using System.Net;
...
static class Reader
{
    ...
    public static int NextInt
    {
        ...
        get
        {
            int res = 0; byte next; while ((next = Next) < 48) ;
            do { res = res * 10 + (next ^ 48); } while (48 <= (next = Next));
            return res;
        }
    }
    ...
    public static int NextSInt
    {
        ...
        get
        {
            int res = 0; byte next; int sign = 1; do { next = Next; } while (next < 45); if (next == 45) { next = Next; sign = -1; }
    ...
    public static long NextSLong
    {
        ...
        get
        {
            long res = 0; byte next; int sign = 1; do { next = Next; } while (next < 45); if (next == 45) { next = Next; sign = -1; }
            do { res = res * 10 + (next ^ 48); next = Next; } while (48 <= next);
            return res * sign;
        }
    }
