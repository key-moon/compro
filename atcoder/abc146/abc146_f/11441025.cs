// detail: https://atcoder.jp/contests/abc146/submissions/11441025
using System;
...
public static class P
{
    public static void Main()
    {
        ...
        if (last == int.MaxValue) Console.WriteLine(-1);
        else Console.WriteLine(string.Join(" ", res.Reverse<int>()));
    }
}
