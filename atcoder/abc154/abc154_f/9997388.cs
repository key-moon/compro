// detail: https://atcoder.jp/contests/abc154/submissions/9997388
using System;
...
public static class P
{
    public static void Main()
    {
        ...
        var r2 = NextInt;
        var c2 = NextInt;
        Console.WriteLine(RangeSum(r2 + 1, c2 + 1) - RangeSum(r1, c2 + 1) - RangeSum(r2 + 1, c1) + RangeSum(r1, c1));
    }
    static ModInt RangeSum(int a, int b) => Factorial(a + b) / Factorial(b) / Factorial(a) - 1;
