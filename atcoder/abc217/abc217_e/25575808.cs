// detail: https://atcoder.jp/contests/abc217/submissions/25575808
using System;
...
public static class P
{
    public static void Main()
    {
        ...
        Queue<int> appended = new Queue<int>();
        PriorityQueue<int> sorted = new PriorityQueue<int>();
        for (int i = 0; i < q; i++)
        {
            ...
            {
                case 1:
                    appended.Enqueue(query[1]);
                    break;
                case 2:
                    if (sorted.Count != 0) Console.WriteLine(sorted.Pop());
                    else Console.WriteLine(appended.Dequeue());
                    break;
                case 3:
                    while (appended.Count != 0)
                        sorted.Push(appended.Dequeue());
                    break;
            }
        }
    }
