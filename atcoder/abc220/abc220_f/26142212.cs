// detail: https://atcoder.jp/contests/abc220/submissions/26142212
using System;
...
public static class P
{
    public static void Main()
    {
        ...
        ReRooting<(long, int)> solver = new ReRooting<(long, int)>(
            n,
            ...
            (x, _) => (x.Item1 + x.Item2, x.Item2 + 1)
        );
        for (int i = 0; i < n; i++)
        {
            Console.WriteLine(solver.Query(i).Item1);
        }
    }
}
