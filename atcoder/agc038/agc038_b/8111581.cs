// detail: https://atcoder.jp/contests/agc038/submissions/8111581
using System;
using System.IO;
using System.Net;
...
public static class P
{
    ...
    public static void Main()
    {
        ...
        MonoidAggregationQueue<int> rmin = new MonoidAggregationQueue<int>(Min, int.MaxValue);
        MonoidAggregationQueue<int> rmax = new MonoidAggregationQueue<int>(Max, int.MinValue);
