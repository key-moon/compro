// detail: https://atcoder.jp/contests/ahc002/submissions/22073888
using System;
...
public static class P
{
    ...
    public const int BEAM_WIDTH_MAX = 140;
    public const int BEAM_WIDTH_INIT = 1;
    public const double BEAM_WIDTH_RATIO = 2;
    public const int STEP = 3;
    public const int CNT = 3;
    public const int SCORE_CNT = 1;

    public const int SNAP = 10;
    public const int ATTEMPT = 7;

    public readonly static Random rng = new Random(1337);
    ...
    public static void Main()
    {
        ...
        Console.Error.WriteLine(resState.Score);
        Console.WriteLine(resState.Moves);
    }
