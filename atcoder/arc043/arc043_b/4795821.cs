// detail: https://atcoder.jp/contests/arc043/submissions/4795821
using System;
using System.IO;
using System.Linq;
...
static class P
{
    static void Main()
    {
        ...
        for (int i = 1; i < 4; i++)
        {
            ...
            {
                // int List<T>.BinarySeach(T) はTが存在した場合はそのindexを、しない場合はT以上のうち最小のIndex(存在しない場合はList<T>.Count)の補数を返す
