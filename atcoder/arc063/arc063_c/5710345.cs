// detail: https://atcoder.jp/contests/arc063/submissions/5710345
using System;
using System.Linq;
...
static class P
{
    static void Main()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (query.Parity == Parity.None || 
                query.LowerBound > query.UpperBound || 
                (query.LowerBound == query.UpperBound && ((query.Parity == Parity.Even) ^ (query.LowerBound % 2 == 0))))
            {
