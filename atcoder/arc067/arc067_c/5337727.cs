// detail: https://atcoder.jp/contests/arc067/submissions/5337727
using System;
using System.IO;
using System.Linq;
    ...
    static void Main()
    {
        ...
        for (int memberCount = a; memberCount <= b; memberCount++)
        {
            ...
            for (int groupCount = c; groupCount <= d; groupCount++)
            {
                ...
                //選択したものをi個にする→選択する前はi - memberCount * groupCount個残りのn - (i - memberCount * groupCount)個の中からmemberCount * groupCount個選ぶ
