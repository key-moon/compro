// detail: https://atcoder.jp/contests/chokudai002/submissions/2513955
using System;
using System.Linq;
...
class P
{
    static void Main()
    {
        ...
        //5400*(n^5) + p1*p2*p3
        var p = prime(1000);
        Console.WriteLine(string.Join("\n", p.Skip(4 + 3).Take(98).Select(x => x * 5400).Concat(new int[] { 5400 * power(7, 5), p.Skip(4).Take(3).Aggregate((x, y) => x * y) })));
    }
