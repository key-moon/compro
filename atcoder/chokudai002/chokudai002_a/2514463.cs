// detail: https://atcoder.jp/contests/chokudai002/submissions/2514463
using System;
using System.Linq;
...
class P
{
    static void Main()
    {
        ...
        //5400*(n^5) + p1^2*p2^2
        var p = prime(1000);
        Console.WriteLine(string.Join("\n", p.Skip(4 + 2).Take(98).Select(x => x * 5400).Concat(new int[] { 5400 * power(7, 5), p.Skip(4).Take(2).Aggregate((x, y) => x * x * y) })));
    }
