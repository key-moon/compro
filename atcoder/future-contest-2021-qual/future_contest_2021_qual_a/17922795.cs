// detail: https://atcoder.jp/contests/future-contest-2021-qual/submissions/17922795
using System;
...
class Solver
{
    ...
    public string AnnealOnHilbert()
    {
        ...
        while (true)
        {
            if ((cnt & 1024) == 0)
            {
                var progress = (double)(DateTime.Now - StartAt).Ticks / Const.TL;
...
static class Const
{
    ...
    public const long TL = 3 * TickPerSec;
}
