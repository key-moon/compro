// detail: https://atcoder.jp/contests/hhkb2020/submissions/17289150
using System;
...
public static class P
{
    public static void Main()
    {
        ...
        SegmentTree<int> segTree = new SegmentTree<int>(Enumerable.Range(0, 200001).ToArray(), int.MaxValue, Min);
        foreach (var item in a)
        {
            segTree[item] = int.MaxValue;
            Console.WriteLine(segTree.Query(0, segTree.Size - 1));
        }
    }
}
