// detail: https://atcoder.jp/contests/kupc2012pr/submissions/5286280
using System;
using System.IO;
using System.Linq;
...
static class P
{
    static void Main()
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            ...
            if (a * (b * randomVector) != c * randomVector)
            {
...
class Matrix : IEquatable<Matrix>
{
    ...
    public static Matrix operator *(Matrix a, Matrix b) => Multiple(a, b);
