// detail: https://atcoder.jp/contests/tokiomarine2020/submissions/14435680
using System;
...
class RangeGetSegmentTree<T>
{
    ...
    public void Operate(int l, int r, T x)
    {
        ...
        while (l <= r)
        {
            if ((l & 1) == 1) Operators[l] = Monoid.Operation(Operators[l], x);
            if ((r & 1) == 0) Operators[r] = Monoid.Operation(Operators[r], x);
            l = (l + 1) / 2;
            r = (r - 1) / 2;
        }
    }
    ...
    private void Eval(int section)
    {
        ...
        Operators[leftChild] = Monoid.Operation(Operators[leftChild], Operators[section]);
        Operators[rightChild] = Monoid.Operation(Operators[rightChild], Operators[section]);
