// detail: https://codeforces.com/contest/1221/submission/60853885
using System;
using System.IO;
using System.Net;
...
public static class P
{
    ...
    static bool Solve()
    {
        ...
        PriorityQueue<long> stack = new PriorityQueue<long>();
        foreach (var item in s) stack.Push(item);
        while (stack.Count >= 2)
        {
            var first = stack.Pop();
            var second = stack.Pop();
            if (first == 2048 || second == 2048) return true;
            if (first != second) stack.Push(second);
            else stack.Push(second << 1);
        }
        while (stack.Count > 0) if (stack.Pop() == 2048) return true;
        return false;
    }
}
