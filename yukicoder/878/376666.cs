// detail: https://yukicoder.me/submissions/376666
using System;
using System.IO;
using System.Net;
...
public static class P
{
    public static void Main()
    {
        ...
        foreach (var chunk in queries.Where(x => chunkSize < x.Elem.Length).GroupBy(x => x.Elem.L >> shiftRange))
        {
            List<int> highCand = new List<int>();
            var chunkEnd = Min(n - 1, (chunk.Key + 1) << shiftRange);
            highCand.Add(-1);
            var curInd = chunkEnd;
